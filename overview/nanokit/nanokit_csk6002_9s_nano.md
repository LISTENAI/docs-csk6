...
CSK-6-NanoKit V1.0 是一款板载了CSK6002+XR819S模组的NanoKit开发板，您可以通过本开发板快速基于CSK6002芯片进行含无线网络功能在内的应用开发，并搭配其他功能扩展板搭建更加完整的硬件原型。
...
CSK-6-NanoKit V1.0 开发板具备以下主要特性：

- 板载**CSK6002+XR819S**在离线模组，具备WIFI&BLE联网功能
- 芯片所有可用管脚引出至两侧2.54mm间距排针，方便使用
- 板载按键与LED，可快速进行基础功能验证
- 板载调试器IC，外接一条USB线即可实现供电、烧录、调试、串口日志查看
- 可搭配功能扩展板使用，衍生丰富玩法
...
CSK-6-NanoKit V1.0 将CSK6002芯片默认的所有可用引脚均引至两侧的2.54mm排针座上，开发者可根据需要自行选用。
...
| CSK-6-NanoKit V1.0 管脚功能参考布局图| [下载](./_downloads/csk-6-nanokit_v1.0_pinfun.png) |
