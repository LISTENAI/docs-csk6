...
| 开发板组合 | 编译所用板型 |
| --------- | ------------ |
| [CSK6011-NanoKit](../overview/nanokit/csk6011_nanokit) + C3网络功能模块  | ``csk6011a_c3_nano`` |
| [CSK6012-NanoKit](../overview/nanokit/csk6012_nanokit) + C3网络功能模块  | ``csk6012_c3_nano`` |
...
| 资源 | 说明 |
| -------------- | -------------|
| [烧录工具与指引](./_downloads/flash_download_tool_3.9.2.zip) | C3模组烧录所需的工具，内含操作指引文档。 |
