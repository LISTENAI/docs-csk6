...
NanoKit 开发套件按功能划分为**核心模组**、**NanoKit开发**板与**功能扩展板**。

### 核心模组

核心模组是集成了SK6系芯片及其外围最小电路的单元，在NanoKit开发套件中一般直接与NannoKit开发板配合使用。
...
NanoKit开发板板载CSK6核心模组以及上手开发常用的硬件外设(如LED、按键、调试器等)，并在可用引脚全部引出至排针，方便用户快速进行应用开发与验证。
...
[csk6002-9s-nano](./nanokit_csk6002_9s_nano)

[csk6011a-9s-nano](./nanokit_csk6011a_9s_nano) 
